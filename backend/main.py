...
@app.get("/v1/measurements/", response_model=List[schemas.Measurment])
def read_all_measurements(skip: int = 0, limit: int = 100, db: Session = Depends(get_db)):
